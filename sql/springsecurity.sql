...
insert  into `role`(`id`,`role_name`,`role_key`) values (1,'超级管理员','ROLE_admin'),(2,'普通管理员','ROLE_common'),(3,'二级vip','ROLE_vip2'),(4,'三级VIP','ROLE_vip3');
...
insert  into `user`(`id`,`username`,`password`,`phone`,`sex`,`address`,`nick_name`) values (0,'admin','$2a$10$0VcYqapw8i5rGV.HnXa2qu0.ur68TIPURLsB1Z.2cuqfDnj/5VVh6','1234567','1','似懂非懂1','管理员'),(1,'root','$2a$10$RMuFXGQ5AtH4wOvkUqyvuecpqUSeoxZYqilXzbz50dceRsga.WYiq','15356789078','2','贵州省贵阳市云岩区','管理员'),(6,'小灰灰','$2a$10$RMuFXGQ5AtH4wOvkUqyvuecpqUSeoxZYqilXzbz50dceRsga.WYiq','15356789078','1','贵州省贵阳市云岩区','小灰灰');
...
insert  into `user_role`(`id`,`user_id`,`role_id`) values (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,3,2),(6,4,3),(7,6,2),(8,5,1);
